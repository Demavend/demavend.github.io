...
var innerDiv = function(data, i){
	...
	newDiv.innerHTML = '<div class="container"><div class="col"><h1 class="text-center text-primary">'+data.items[i].volumeInfo.title+'</h1><div class="row bg-success"><div class="col-md-2 col-sd-2" style="text-align:center;"><img src="'+data.items[i].volumeInfo.imageLinks.thumbnail+' "width="100%"  class="img-responsive"></img></div><div class="col-md-8 col-sd-8"><h4 class="text-justify">'+data.items[i].volumeInfo.description+'</h4></div><div class="col-md-2 col-sd-2" style="text-align:center;margin-top:90px;"><button class="btn btn-info openModal" name='+i+'  >Показать<br>описание</button></div></div></div></div>';
